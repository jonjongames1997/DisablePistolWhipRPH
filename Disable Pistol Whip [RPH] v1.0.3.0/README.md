...
2. Place the DLL and PDB into your 'plugins' folder
3. Launch the game and open the Rage Console then load the plugin -- the plugin will create `DisablePistolWhip.ini` next to the DLL on first run.
